...
(function ($) {
    ...
    function RowSelectionModel(options) {
        ...
        function handleActiveCellChange(e, data) {
            if (_options.selectActiveRow && ic3TriggersSelection(data) && data.row != null) {
        ...
        function ic3TriggersSelection(cell) {
            return !_options.lastSelectableCol || cell.cell < _options.lastSelectableCol;
        }

        function handleClick(e) {
            var cell = _grid.getCellFromEvent(e);
            if (!cell || !ic3TriggersSelection(cell) || !_grid.canCellBeActive(cell.row, cell.cell)) {
                return false;
            }
